...
def init_themes():
    ...
    themes[(lua_ntAdd, lua_ntSubtract, lua_ntMultiply, lua_ntDivide, lua_ntModulus,
            lua_ntPower, lua_ntFloorDivide, lua_ntUnaryMinus, lua_ntLength)] = blue_theme
    ...
    themes[(lua_ntWhileLoop, lua_ntForLoop, lua_ntIteratePairs, lua_ntIterateIPairs,
            lua_ntRepeatUntil, lua_ntIf, lua_ntElseIf, lua_ntElse, lua_ntBreak)] = yellow_theme
